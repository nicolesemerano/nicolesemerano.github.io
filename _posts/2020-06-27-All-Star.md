...
I also dealt with the obvious class imbalance.  There are many methods to accommodating this, but I chose to do it before the actual training of the model.  I wanted to start fresh.  I multiplied the minority class by 5 to oversample it.  I experimented with higher numbers but this caused the model to predict more 0s than it should.  
...
At the time of me writing this blog, I will readily admit the style of my app is soooooo basic.  It looks like something a 3rd grader would make.  I have since made more complex CSS designs as you can see in other posts, but I was just proud that it worked. I used the Random Forest model solely in this stage as it could predict statistics that did not come from my pandas table.  Below I have a video of my app in action. I took the statistics of Hank Aaron in 1972, where his numbers were not like in other seasons. Before all you Braves fans think I'm hating on Hank Aaron, I consider him to be the true home run record holder and have great admiration for his career.  I use this example as proof of some of the bias in this selection process.


![](../images/All_Star_App.gif)

Here he "only" had 34 home runs that season, his batting average was .265, and his RBI and run totals were the lowest since his 1st season.  Yet he had been named an All-Star, probably more out of his notoriety and past accomplishments.  This model and app shows he should not have been an All-Star that year. 
